 ...
 */
class Version20171023160345 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus_scientist DROP FOREIGN KEY FK_2656D0B185C4074C');
        $this->addSql('ALTER TABLE genus_scientist DROP FOREIGN KEY FK_2656D0B1A76ED395');
